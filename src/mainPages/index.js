...
class IctukV5 extends Dictionary {
  rawEntries = [
    ...
    "poshozh|they|Pn.|that other person|",
    "oshozh|it|Pn.|that other animal  thing|",
    "pozh|they|Pn.|those people|",
    "ozh|it|Pn.|those animals  things|",
    "pozhozh|they|Pn.|those other people|",
    "ozhozh|it|Pn.|those other animals  things|",
    ...
    "shazh|those|Pn.|the people/things indicated/mentioned/understood from the situation|",
